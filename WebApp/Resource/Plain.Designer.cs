...
namespace WebApp.Resource {
    ...
    public class Plain {
        ...
        /// <summary>
        ///   Looks up a localized string similar to * This program is not a commercial application and is used only for educational purposes. The entire range and prices are fictitious. You can not purchase a real car with this program. 2018 M.Binger.
        /// </summary>
